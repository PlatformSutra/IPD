...
#ITS_train_loader=DataLoader(dataset=RESIDE_Dataset(path+'/RESIDE/ITS',train=True,size=opt.crop_size),batch_size=BS,shuffle=True)
ITS_train_loader=DataLoader(dataset=RESIDE_Dataset(path+'/RESIDE/ITS',train=True,size=opt.crop_size),batch_size=BS,shuffle=True)
...
OTS_train_loader=DataLoader(dataset=RESIDE_Dataset(path+'/RESIDE/OTS',train=True,size=opt.crop_size),batch_size=BS,shuffle=True)
